...
export default function ThreeModel({ dark, ...props }) {
  const { nodes, materials } = useSpline('/static/3d/scene.spline')
    ...
    <>
      <group {...props} dispose={null}>
        ...
        <group ref={sceneContent}>
          <group name="Group" position={[211.09, 110.65, 254.62]} rotation={[0.01, -0.29, -0.42]}>
            <mesh
              name="Sphere 4"
          ...
          <group name="picture" position={[337.87, -189.84, -261.37]} rotation={[-0.17, 0.08, 0]}>
            <mesh
              name="Rectangle 21"
          ...
          <group name="plant2" position={[433.73, -87.11, -27.42]} rotation={[0, -0.61, 0]}>
            <mesh
              name="Cube 10"
          ...
          <group name="people" position={[54.84, 0.52, 141.56]}>
            ...
            <group name="chair" position={[17.29, -213.5, -71.28]} rotation={[0, -Math.PI / 6, 0]}>
              <mesh
                name="Cube 91"
            ...
            />
            <group name="body" position={[5.06, 49.66, -37.85]} rotation={[0, -Math.PI / 6, 0]}>
              <mesh
                name="line"
            ...
            />
            <group name="head" position={[18.51, 200.48, -52.92]} rotation={[0.4, -0.49, 0.19]}>
              <mesh
                name="Cube6"
